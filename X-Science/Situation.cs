			...
			_description = string.Format("{0} {1}{2}",
				...
				string.IsNullOrEmpty(_formattedBiome)
					...
					: string.IsNullOrEmpty(_formattedSubBiome)
						? string.Format((Localizer.Format("#autoLOC_[x]_Science!_052")/*'s*/) + "{0}", _formattedBiome)
						: string.Format((Localizer.Format("#autoLOC_[x]_Science!_052")/*'s*/ ) + "{0} ({1})", _formattedSubBiome, _formattedBiome));
		}
